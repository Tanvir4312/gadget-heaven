...
const Dashboard = () => {
    ...
    return (
        <div>
                ...
                <div className="modal-box">
                    ...
                    <div className="modal-action">
                        <form method="dialog">
                            ...
                            <button onClick={() => handleModalClose('close')} className="btn">Close</button>
            ...
            <div>
                {
                    isActive.cart ?
                        <>
                            <div className="flex justify-between items-center md:pr-32 pr-10 pt-10">
                                <p className="text-xl font-medium md:pl-32 pl-10 pt-20 md:pt-0">Cart</p>
                                <div className="flex items-center gap-6">
                                    <p className="text-2xl font-bold">Total Cost: {sum}</p>
                                    <div className="flex btn btn-outline border border-[#9538E2] rounded-full w-[180px]">
                                    ...
                                    <div>
                                        ...
                                        <button className="btn btn-outline border border-[#9538E2] rounded-full" onClick={() => document.getElementById('my_modal_1').showModal()}>Purchase</button>
                                    </div>
                                </div>
                            </div>
                        </>
            ...
            {
                isActive.cart ?
                    storedCard.map(card => <div className=" md:flex gap-7 p-5 border border-base-300 md:mx-32 mx-10 mb-6 mt-6 rounded-lg" key={card.product_id}>
                        <div>
